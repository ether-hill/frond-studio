...
export const PERSONAL_PROJECTS: PersonalProject[] = [
  ...
  },
  {
    ...
    summary:
      "A from-scratch rebuild of the data center sim, on a green river plain shared with a small town. Everything runs on the clock — solar by day, a dirty pricier grid at night, batteries in between — and scale has a price: the chillers roar (turn on Sound), grid carbon smogs the town, and community sentiment falls as the neighbors lose patience.",
    year: "2026",
